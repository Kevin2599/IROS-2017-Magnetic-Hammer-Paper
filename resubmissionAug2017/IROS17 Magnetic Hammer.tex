% gs -sDEVICE=pdfwrite -dCompatibilityLevel=1.4 -dNOPAUSE -dQUIET -dBATCH      -sOutputFile=CompressedMagHammer.pdf 'IROS17 Magnetic Hammer.pdf'
\documentclass[letterpaper, 10 pt, journal, twoside]{ieeetran} 
%\documentclass[letterpaper, 10 pt, conference]{ieeeconf}  % Comment this line out if you need a4paper
\usepackage{graphicx}

% Paper headers 
\markboth{IEEE Robotics and Automation Letters. Preprint Version. Accepted July, 2017}
{Leclerc \MakeLowercase{\textit{et al.}}: Magnetic Hammer Actuation for Tissue Penetration using a Millirobot}  
...
\author{Julien Leclerc$^{1}$, Ashwin Ramakrishnan$^{2}$, Nikolaos V. Tsekos$^{3}$, and Aaron T. Becker$^{1}$% <-this % stops a space
\thanks{Manuscript received: Feb., 15, 2017; Revised June, 4, 2017; Accepted July, 12, 2017.}%Use only for final RAL version
\thanks{This letter was recommended for publication by Editor Ken Masamune upon evaluation of the Associate Editor and Reviewers' comments. *This work was supported by the National Science Foundation under Grant No.\  [CNS-1646566].}%Use only for final RAL version %\href{http://nsf.gov/awardsearch/showAward?AWD_ID=1646566}{
